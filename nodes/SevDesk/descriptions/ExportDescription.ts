		...
		options: [
			...
			},
			{
				...
				routing: {
					...
					output: {
						postReceive: [
							{ type: 'binary', properties: { dataProperty: 'data', fileName: 'export.zip' } } as any,
						],
					},
				},
			},
			{
				...
				action: 'Start an export that generates booking data in the DATEV format (CSV)',
				routing: {
					request: {
						method: 'GET',
			...
			},
			{
				...
				action: 'Start an export that generate invoice data in the DATEV format (XML)',
				routing: {
					request: {
						method: 'GET',
			...
			},
			{
				...
				action: 'Generates an identifier to request the current export progress',
				routing: {
					request: {
						method: 'GET',
			...
			},
			{
				...
				action: 'When the export job has finished you can call this endpoint to get the download all',
				routing: {
					request: {
						method: 'GET',
			...
			},
			{
				...
				routing: {
					...
					output: {
						postReceive: [
							{ type: 'binary', properties: { dataProperty: 'data', fileName: 'invoices.csv' } } as any,
						],
					},
				},
			},
			{
				...
				routing: {
					...
					output: {
						postReceive: [
							{ type: 'binary', properties: { dataProperty: 'data', fileName: 'invoices.zip' } } as any,
						],
					},
				},
			},
			{
				...
				routing: {
					...
					output: {
						postReceive: [
							{ type: 'binary', properties: { dataProperty: 'data', fileName: 'creditnotes.csv' } } as any,
						],
					},
				},
			},
			{
				...
				routing: {
					...
					output: {
						postReceive: [
							{ type: 'binary', properties: { dataProperty: 'data', fileName: 'vouchers.csv' } } as any,
						],
					},
				},
			},
			{
				...
				routing: {
					...
					output: {
						postReceive: [
							{ type: 'binary', properties: { dataProperty: 'data', fileName: 'vouchers.zip' } } as any,
						],
					},
				},
			},
			{
				...
				routing: {
					...
					output: {
						postReceive: [
							{ type: 'binary', properties: { dataProperty: 'data', fileName: 'transactions.csv' } } as any,
						],
					},
				},
			},
			{
				...
				routing: {
					...
					output: {
						postReceive: [
							{ type: 'binary', properties: { dataProperty: 'data', fileName: 'contacts.csv' } } as any,
						],
					},
				},
			},
...
export const exportFields: INodeProperties[] = [
	...
	},
	{
		...
		options: [
			{ displayName: 'Accountant Number', name: 'accountantNumber', type: 'number', default: 0 },
			{ displayName: 'Accountant Client Number', name: 'accountantClientNumber', type: 'number', default: 0 },
			{ displayName: 'Accounting Year Begin', name: 'accountingYearBegin', type: 'string', default: '' },
		],
	},
	{
		displayName: 'Options',
		...
		options: [
			{ displayName: 'Download', name: 'download', type: 'boolean', default: false },
			...
			{ displayName: 'Archive Documents', name: 'archiveDocuments', type: 'boolean', default: false },
			{ displayName: 'Enshrine Documents', name: 'enshrineDocuments', type: 'boolean', default: false },
			{ displayName: 'Stateless', name: 'stateless', type: 'boolean', default: false },
			{ displayName: 'Export By Payday', name: 'exportByPayday', type: 'boolean', default: false },
			{ displayName: 'Include Enshrined', name: 'includeEnshrined', type: 'boolean', default: false },
			{ displayName: 'Include Exported Documents', name: 'includeExportedDocuments', type: 'boolean', default: false },
			{ displayName: 'Include Document XML', name: 'includeDocumentXml', type: 'boolean', default: false },
			{ displayName: 'Job ID', name: 'jobId', type: 'string', default: '' },
			{ displayName: 'Hash', name: 'hash', type: 'string', default: '' },
			{ displayName: 'Sev Query', name: 'sevQuery', type: 'string', default: '' },
		],
	},
];