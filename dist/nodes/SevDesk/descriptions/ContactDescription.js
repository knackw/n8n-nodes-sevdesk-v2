                ...
                routing: {
                    request: {
                        ...
                        qs: {
                            ...
                            'customFieldSetting[objectName]': '={{$parameter.customFieldSetting.objectName}}',
                ...
                routing: {
                    request: {
                        ...
                        qs: {
                            ...
                            'category[objectName]': '={{$parameter.filters.category.objectName}}',
                            ...
                            'country[objectName]': '={{$parameter.filters.country.objectName}}',
                            ...
                            'orderBy[customerNumber]': '={{$parameter.filters["orderBy[customerNumber]"]}}',
                        },
                    },
                    output: {
                        postReceive: [{ type: 'rootProperty', properties: { property: 'objects' } }],
...
const contactCreateAndUpdateFields = [
    {
        displayName: 'Name',
        name: 'name',
        type: 'string',
    ...
    },
    {
        ...
        options: [
            ...
            { displayName: 'Object Name', name: 'objectName', type: 'string', default: 'Contact' },
        ],
    ...
    { displayName: 'Bank Number', name: 'bankNumber', type: 'string', default: '' },
    { displayName: 'Default Cashback Time', name: 'defaultCashbackTime', type: 'number', default: 0 },
    {
    ...
    { displayName: 'Default Time To Pay', name: 'defaultTimeToPay', type: 'number', default: 0 },
    { displayName: 'Tax Number', name: 'taxNumber', type: 'string', default: '' },
    { displayName: 'Exempt Vat', name: 'exemptVat', type: 'boolean', default: false },
    { displayName: 'Buyer Reference', name: 'buyerReference', type: 'string', default: '' },
    { displayName: 'Government Agency', name: 'governmentAgency', type: 'boolean', default: false },
];
exports.contactFields = [
    {
        ...
        displayOptions: {
            show: {
                resource: ['contact'],
                operation: ['get', 'update', 'delete', 'getNumberOfItems', 'isDeletable'],
            },
        },
    },
    {
        ...
        options: [
            {
                ...
                type: 'number',
                default: 1,
                description: 'Defines if both organizations and persons should be returned. 0 for only organizations, 1 for organizations and persons.',
            },
            {
                displayName: 'Category',
                name: 'category',
            ...
            { displayName: 'City', name: 'city', type: 'string', default: '' },
            {
                ...
                options: [
                    { displayName: 'ID', name: 'id', type: 'string', default: '' },
                    { displayName: 'Object Name', name: 'objectName', type: 'string', default: 'Tag' },
                ],
            },
            ...
            { displayName: 'Zip', name: 'zip', type: 'string', default: '' },
            {
                ...
                options: [
                    { displayName: 'ID', name: 'id', type: 'string', default: '' },
                    { displayName: 'Object Name', name: 'objectName', type: 'string', default: 'StaticCountry' },
                ],
            },
            { displayName: 'Create Before', name: 'createBefore', type: 'dateTime', default: '' },
            { displayName: 'Create After', name: 'createAfter', type: 'dateTime', default: '' },
            { displayName: 'Update Before', name: 'updateBefore', type: 'dateTime', default: '' },
            { displayName: 'Update After', name: 'updateAfter', type: 'dateTime', default: '' },
            {
