...
exports.creditNoteFields = exports.creditNoteOperations = void 0;
exports.creditNoteOperations = [
    {
            ...
            },
            {
                ...
                routing: {
                    request: {
                        ...
                        qs: '={{$parameter.options}}',
                        encoding: 'raw',
                    },
                    output: {
                        postReceive: [
                            { type: 'binary', properties: { dataProperty: 'data', fileName: '={{$response.body.filename}}' } },
                        ],
                    },
                },
            },
...
const creditNoteModel = [
    { displayName: 'Credit Note Number', name: 'creditNoteNumber', type: 'string', default: '' },
    {
        displayName: 'Contact',
        name: 'contact',
        type: 'collection',
    ...
    { displayName: 'Credit Note Date', name: 'creditNoteDate', type: 'string', default: '' },
    {
        displayName: 'Status',
        name: 'status',
        type: 'options',
    ...
    { displayName: 'Head Text', name: 'headText', type: 'string', typeOptions: { multiline: true }, default: '' },
    { displayName: 'Foot Text', name: 'footText', type: 'string', typeOptions: { multiline: true }, default: '' },
...
exports.creditNoteFields = [
    ...
    },
    {
        ...
        options: [
            { displayName: 'Contact ID', name: 'contact[id]', type: 'string', default: '' },
            { displayName: 'Credit Note Number', name: 'creditNoteNumber', type: 'string', default: '' },
    ...
    },
    {
        ...
        options: [
            { displayName: 'Credit Note', name: 'creditNote', type: 'collection', placeholder: 'Add Credit Note', default: {}, options: creditNoteModel },
            {
                ...
                options: [
                    { name: 'values', displayName: 'Values', values: [] },
                ],
            },
        ],
    },
    ...
    },
    {
        ...
        options: [
            { displayName: 'ID', name: 'id', type: 'string', default: '' },
            { displayName: 'Object Name', name: 'objectName', type: 'string', default: 'Invoice' },
        ],
    },
    {
    ...
    },
    {
        ...
        options: [{ displayName: 'Download', name: 'download', type: 'boolean', default: false }],
    },
    {
        ...
        options: [{ displayName: 'Type', name: 'type', type: 'string', default: '' }],
    },
    {
        ...
        options: [{ displayName: 'Send Type', name: 'sendType', type: 'string', default: '' }],
    },
    {
        ...
        options: [
            ...
            { displayName: 'Type', name: 'type', type: 'string', default: '' },
            {
                ...
                options: [
                    { displayName: 'ID', name: 'id', type: 'string', default: '' },
                    { displayName: 'Object Name', name: 'objectName', type: 'string', default: 'CheckAccount' },
                ],
            },
        ],
    },
];
//# sourceMappingURL=CreditNoteDescription.js.map