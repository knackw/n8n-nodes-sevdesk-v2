...
exports.orderFields = [
    {
        ...
        displayOptions: {
            show: {
                resource: ['order'],
                operation: ['get', 'delete', 'update', 'sendViaEmail', 'createInvoice', 'downloadPdf'],
            },
        },
    },
    {
    ...
    },
    {
        ...
        description: 'Whether to create a partial invoice. If true, a new invoice will be created with the sum of all not yet billed order positions.',
    },
];
